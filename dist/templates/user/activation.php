          ...
          switch ($_POST["verifyUser"]) {
            ...
            case 'Valider':
              ...
              if ($verificationCode == $enteredCode) {
                ...
                echo '<div class="alert alert-warning py-5 my-5">Votre compte a été activé avec succès !<br>Vous pouvez à présent vous rendre dans votre espace client, cliquez <a href="index.php?controller=auth&action=login">ici</a></div>';
