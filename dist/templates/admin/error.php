<?php require_once _TEMPLATEPATH_ . '/admin/header.php'; ?>
...
<section class="container my-5">
  ...
  <div class="mt-5 text-center">
    <a href="/index.php?controller=admin&action=home" class="btn btn-gamestore text-uppercase">Retourner à l'accueil</a>
  </div>
</section>
