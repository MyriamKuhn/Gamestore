...
class GamesRepository extends MainRepository
{
  ...
  // Récupération de la liste des jeux pour la page d'accueil du site
  public function getNewGamesList(int $limit): array
  {
    $query = "SELECT
    g.id AS game_id,
    g.name AS game_name,
  ...
  // Récupération de la liste des jeux en promotion pour la page d'accueil du site
  public function getReducedGamesList(int $limit): array
  {
    $query = 
    'SELECT
    g.id AS game_id,
    ...
    MAX(gp.discount_rate) AS discount_rate,
  ...
  // Récupération de la liste complète des jeux en promotion pour la page d'affichage de toutes les promotions récupérées en format JSON pour optimiser les filtres
  ...
  public function getGamesList(int $limit = null): array
  {
    $query = "SELECT
    g.id AS game_id,
    g.name AS game_name,
